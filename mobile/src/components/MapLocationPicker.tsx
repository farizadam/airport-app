        ...
        if (isValidLocation && Math.abs(latitude) <= 90 && Math.abs(longitude) <= 180) {
          ...
          try {
            ...
            if (lastKnown && (lastKnown.coords.latitude !== 0 || lastKnown.coords.longitude !== 0)) {
              ...
              mapRef.current?.panToLocation(lastKnown.coords.latitude, lastKnown.coords.longitude);
            ...
            mapRef.current?.panToLocation(defaultLat, defaultLon);
...
const styles = StyleSheet.create({
  ...
  floatingButtonContainer: {
    position: 'absolute',
    bottom: 220, // Push it entirely above the confirmation panel & safe areas
    right: 16,
    zIndex: 90,
  },
  gpsButton: {
