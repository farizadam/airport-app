  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        showAirports={false}
      />
      <ScrollView style={styles.scrollView} contentContainerStyle={{ paddingBottom: 60 + insets.bottom }} showsVerticalScrollIndicator={false}>
        {/* Header */}
        ...
        >
          <View style={{ flex: 1 }}>
            <SafeAreaView edges={["top"]} style={styles.mapHeaderSafeArea}>
