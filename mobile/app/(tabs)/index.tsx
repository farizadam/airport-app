  ...
  return (
    ...
    >
      ...
      <View style={styles.createSection}>
        ...
        <Text style={styles.sectionSubtitle}>Share your ride or find a driver</Text>
        ...
        <View style={styles.createButtons}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <View style={[styles.createButtonInner, { backgroundColor: "#FEF3C7" }]}>
              <View style={[styles.createButtonIconBg, { backgroundColor: "#F59E0B" }]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <View style={[styles.createButtonInner, { backgroundColor: "#DBEAFE" }]}>
              <View style={[styles.createButtonIconBg, { backgroundColor: "#3B82F6" }]}>
