        ...
        <View style={styles.section}>
          ...
          <View style={styles.detailsGrid}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                const passengerObj = request.passenger;
                const passengerId = passengerObj?._id || passengerObj?.id || null;
                if (passengerId) {
            ...
            >
              <ProfileAvatar
                userId={request.passenger?._id || request.passenger?.id}
                firstName={request.passenger?.first_name}
                lastName={request.passenger?.last_name}
                avatarUrl={request.passenger?.avatar_url || undefined}
