          ...
          <View style={styles.routeContainer}>
            ...
            <View style={styles.enhancedRoutePoint}>
              <View style={styles.routePointLeftSide}>
                <View style={[styles.routeMarker, { backgroundColor: "#3B82F6" }]}>
              ...
              <View style={styles.routePointDetails}>
                <Text style={styles.routePointLabel}>
                  {request.direction === 'to_airport' ? "PICKUP LOCATION" : "DEPARTURE"}
                </Text>
        ...
        <View style={styles.footer}>
          <TouchableOpacity 
            ...
            onPress={() => router.push({
              ...
              params: {
                prefillAirportId: typeof request.airport === 'object' ? request.airport._id : request.airport,
                prefillDirection: request.direction === 'to_airport' ? 'home_to_airport' : 'airport_to_home',
