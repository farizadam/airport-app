...
import {
  ...
  LOCATION_COLORS,
  TripData,
} from "../../src/utils/tripDisplayUtils";
...
export default function RideDetailsScreen() {
      ...
      if (result.success) {
        ...
        Alert.alert(
          ...
          [
            {
              text: "OK",
              onPress: () => router.replace("/(tabs)/explore?tab=active"),
            },
          ],
        );
      } else {
  ...
  const hasAcceptedBookings = rideBookings?.some(
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "bottom"]} key={id}>
      ...
      >
          ...
          (() => {
            ...
            > = {
              ...
              accepted: {
                ...
                subtitle:
                  "Your seat is secured. You can view the map and contact the driver.",
              },
              rejected: {
                icon: "close-circle",
                color: "#DC2626",
                ...
                subtitle:
                  "The driver did not accept your booking. You have not been charged.",
              },
              cancelled: {
                icon: "ban",
                color: "#DC2626",
                ...
                subtitle:
                  "This booking has been cancelled. Any payment will be refunded to your wallet.",
              },
            };
            ...
            return (
              ...
              >
                <View style={styles.bookingBannerHeader}>
                  ...
                  <Text
                    style={[styles.bookingBannerTitle, { color: cfg.color }]}
                  >
                    {cfg.title}
                  </Text>
                </View>
        ...
        {!isOwner && !myBooking && ride.status === "cancelled" && (
          ...
          >
            <View style={styles.bookingBannerHeader}>
              ...
              <Text style={[styles.bookingBannerTitle, { color: "#DC2626" }]}>
                Ride Cancelled
              </Text>
            </View>
            <Text style={styles.bookingBannerSubtitle}>
              This ride has been cancelled by the driver. If you had a booking,
              any payment has been refunded to your wallet.
            </Text>
          </View>
        )}
          ...
          {(() => {
            ...
            return (
              <View style={styles.routeContainer}>
                ...
                <View
                  style={{ marginVertical: 4, width: 20, alignItems: "center" }}
                >
                  <View
                    style={{ width: 2, height: 24, backgroundColor: "#CBD5E1" }}
                  />
                  <Ionicons
                    name="chevron-down"
                    size={16}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Datee & Time</Text>
          ...
          <View style={styles.detailsGrid}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                const driverObj =
                  ride.driver ||
                  (typeof ride.driver_id === "object" ? ride.driver_id : null);
                const driverId =
                  driverObj?.id ||
                  driverObj?._id ||
                  (typeof ride.driver_id === "string" ? ride.driver_id : null);
                console.log(
                  "👤 Driver profile tapped, ID:",
                  driverId,
                  "Driver obj:",
                  driverObj,
                );
        ...
        {!isOwner &&
          ...
          (() => {
            ...
            const totalPrice =
              ...
              (myBooking.seats || myBooking.seats_booked || 1);
                    ...
                    {(ride.driver?.phone ||
                      ...
                      >
                        <Ionicons
                          ...
                          color="#64748B"
                        />
                        <Text style={styles.acceptedDriverPhone}>
                          {" "}
                          {ride.driver?.phone ||
                            ride.driver?.phone_number ||
                            driverObj?.phone}
                ...
                <View style={styles.tripSummaryCard}>
                  ...
                  {(myBooking.luggage_count ?? 0) > 0 && (
                    <View style={styles.tripSummaryRow}>
                      ...
                      <Text style={styles.tripSummaryValue}>
                        {myBooking.luggage_count} item(s)
                      </Text>
                    </View>
                  )}
                  <View style={styles.tripSummaryRow}>
                  ...
                  >
                    <Text
                      style={[styles.tripSummaryLabel, { fontWeight: "700" }]}
                    >
                      Total Paid:
                    </Text>
                    <Text
                      style={[
                        ...
                        { fontWeight: "700", color: "#16A34A", fontSize: 18 },
                      ]}
                    >
                      {totalPrice} EUR
                    </Text>
                ...
                <View style={styles.contactButtonsRow}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      router.push({
                        pathname: "/chat",
                        params: { bookingId: myBooking._id || myBooking.id },
                      })
                    }
                  >
                    <Ionicons name="chatbubbles" size={20} color="#fff" />
                    <Text style={styles.chatContactBtnText}>
                      Chat with Driver
                    </Text>
                  </TouchableOpacity>
                  {(ride.driver?.phone ||
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        Linking.openURL(
                          `tel:${ride.driver?.phone || ride.driver?.phone_number || driverObj?.phone}`,
                        )
                      }
                    >
          ...
          <View style={styles.section}>
            ...
            {rideBookings.map((booking: any) => {
              ...
              const passengerRating =
                booking.passenger_id?.rating || booking.passenger?.rating;
                    ...
                    <View style={styles.passengerDetails}>
                      {(booking.passenger_phone ||
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `tel:${booking.passenger_phone || booking.passenger?.phone}`,
                            )
                          }
                        >
                          <Ionicons
                          ...
                          />
                          <Text
                            style={[styles.bookingInfo, { color: "#007AFF" }]}
                          >
                            {booking.passenger_phone ||
                              booking.passenger?.phone}
                          </Text>
        ...
        {!isOwner &&
          ...
          !myBooking && (
            ...
            >
              ...
              <Text style={styles.primaryButtonText}>Bookk This Ride</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (hasAcceptedBookings) {
                  Alert.alert(
                    "Cannot Modify",
                    "You cannot modify a ride that has confirmed bookings.",
                  );
                  return;
                }
            ...
            <View style={styles.modalContent}>
              ...
              >
                <View style={styles.modalInfo}>
                  ...
                  <Text style={styles.modalInfoText}>
                    Luggage space:{" "}
                    {ride.luggage_left ?? ride.luggage_capacity ?? 0} spot(s)
                  </Text>
                  <Text style={styles.modalInfoText}>
                  ...
                  >
                    <View style={styles.paymentMethodLeft}>
                      <Ionicons
                        ...
                        size={24}
                        color={
                          paymentMethod === "wallet" ? "#16A34A" : "#64748B"
                        }
                      />
