...
export default function ProfileScreen() {
    ...
    try {
      ...
      toast.error(
        ...
        error.response?.data?.message ||
          "Failed to upload profile picture. Try a smaller image.",
      );
    } finally {
  ...
  // Calculate values that depend on user, but always call hooks
        ...
        {profileCompletion < 100 ? (
          ...
          <View
            style={[
              ...
              { borderColor: "#DCFCE7", borderWidth: 1 },
            ]}
          >
            <View style={styles.completionHeader}>
          ...
          <View style={styles.settingsCard}>
            ...
            >
              <View style={styles.settingInfo}>
                <View
                  style={[styles.settingIcon, { backgroundColor: "#E0F2FE" }]}
                >
                  <Ionicons
            ...
            >
              <View style={styles.settingInfo}>
                <View
                  style={[styles.settingIcon, { backgroundColor: "#FEF9C3" }]}
                >
            ...
            >
              <View style={styles.settingInfo}>
                <View
                  style={[styles.settingIcon, { backgroundColor: "#F1F5F9" }]}
                >
                  <Ionicons
            ...
            <View style={styles.modalContent}>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditForm({ ...editForm, car_model: text })
                  }
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditForm({ ...editForm, car_color: text })
                  }
